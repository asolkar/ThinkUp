...
/**
 *
 * ThinkUp/webapp/plugins/statusnet/tests/TestOfStatusNetInstanceMySQLDAO.php
 *
...
class TestOfStatusNetInstanceMySQLDAO extends ThinkUpUnitTestCase {
    protected $DAO;

    public function setUp() {
        parent::setUp();
        $this->DAO = new StatusNetInstanceMySQLDAO();
    ...
    protected function buildData() {
        ...
        'network'=>'statusnet', 'network_viewer_id'=>10, 'crawler_last_run'=>'1988-01-20 12:00:00', 'is_active'=>1, 
        'is_public'=>0));

        $builders[] = FixtureBuilder::build('instances_statusnet', array('last_page_fetched_replies'=>10));

        $builders[] = FixtureBuilder::build('instances', array('network_user_id'=>12, 'network_username'=>'jill',
        'network'=>'statusnet', 'network_viewer_id'=>12, 'crawler_last_run'=>'2010-01-20 12:00:00', 'is_active'=>1, 
        'is_public'=>0));

        $builders[] = FixtureBuilder::build('instances_statusnet', array('last_page_fetched_replies'=>11));

        $builders[] = FixtureBuilder::build('instances', array('network_user_id'=>13, 'network_username'=>'stuart',
        'network'=>'statusnet', 'network_viewer_id'=>13, 'crawler_last_run'=>'2010-01-01 12:00:00', 'is_active'=>0, 
        'is_public'=>1));

        $builders[] = FixtureBuilder::build('instances_statusnet', array('last_page_fetched_replies'=>12));
    ...
    public function testGetFreshestByOwnerId(){
        ...
        $statusnet_instance_builder= FixtureBuilder::build('instances_statusnet',
        ...
        $this->assertIsA($instance, "StatusNetInstance");
        ...
        $statusnet_instance_builder->columns['last_page_fetched_replies']);
        $this->assertEqual($instance->last_page_fetched_tweets,
        $statusnet_instance_builder->columns['last_page_fetched_tweets']);
    ...
    public function testGetInstanceOneByLastRun(){
        ...
        $this->assertIsA($result, "StatusNetInstance");
    ...
    public function testGetByUsernameOnNetwork() {
        ...
        'network'=>'statusnet', 'network_viewer_id'=>15, 'crawler_last_run'=>'2010-01-01 12:00:01', 'is_active'=>1));
        ...
        $result = $this->DAO->getByUsernameOnNetwork('salma', 'statusnet');
        $this->assertIsA($result, "Instance");
        $this->assertIsA($result, "StatusNetInstance");
        $this->assertEqual($result->network_username, 'salma');
        $this->assertEqual($result->network, 'statusnet');
    ...
    public function testGetByUserId() {
        // data do exist
        $result = $this->DAO->getByUserIdOnNetwork(10, 'statusnet');
        $this->assertIsA($result, "Instance");
        $this->assertIsA($result, "StatusNetInstance");
        $this->assertEqual($result->network_username, 'jack');
        $this->assertEqual($result->network_user_id, 10);
        ...
        // data do not exist
        $result = $this->DAO->getByUserIdOnNetwork(11, 'statusnet');
        $this->assertNull($result);
    }
    ...
    public function testGetAllInstancesNoMetaData(){
        ...
        'network_user_id'=>59, 'network'=>'statusnet', 'crawler_last_run'=>'-8d', 'is_activated'=>'1', 'is_public'=>'1',
        'network_viewer_id'=>47));
        $result = $this->DAO->getAllInstances("ASC", true, "statusnet");
    ...
    public function testSaveInstanceNoMetaData(){
        ...
        'network_user_id'=>59, 'network'=>'statusnet', 'crawler_last_run'=>'-8d', 'is_activated'=>'1', 'is_public'=>'1',
        'network_viewer_id'=>47));
        $result = $this->DAO->getByUserIdOnNetwork(59, 'statusnet');
        $this->assertIsA($result, "StatusNetInstance");
        ...
        $updated_result = $this->DAO->getByUserIdOnNetwork(59, 'statusnet');
        $this->assertIsA($updated_result, "StatusNetInstance");
    ...
    public function testGetAllInstances() {
        //getAllInstances($order = "DESC", $only_active = false, $network = "statusnet")
    ...
    public function testGetPublicInstances() {
        ...
        'network'=>'statusnet', 'network_viewer_id'=>13, 'crawler_last_run'=>'2010-01-01 12:00:00', 'is_active'=>1, 
        'is_public'=>1));
        ...
        $this->assertIsA($result[0], "StatusNetInstance");
    ...
    public function testGetByOwnerAndNetwork(){
        $data = array(
            ...
            // Test is-admin statusnet
            $result = $this->DAO->getByOwnerAndNetwork($owner, 'statusnet');
            $this->assertIsA($result, "array");
            $this->assertEqual(count($result), 3);
            $users = array('jill','stuart','jack');
            $uID = array(12,13,10);
            ...
            // Test is-admin StatusNet, forced not
            $result = $this->DAO->getByOwnerAndNetwork($owner, 'statusnet', true);
            $this->assertIsA($result, "array");
            $this->assertEqual(count($result), 2);
            $users = array('jill','jack');
            $uID = array(12,10);
    ...
    public function testInsert() {
        ...
        $i = $this->DAO->getByUserIdOnNetwork(11, 'statusnet');
        $this->assertIsA($i, "StatusNetInstance");
    ...
    public function testDeleteInstance() {
        $i = $this->DAO->getByUsernameOnNetwork('jack', 'statusnet');
        $this->assertNotNull($i);
        $result = $this->DAO->delete('jack', 'statusnet');

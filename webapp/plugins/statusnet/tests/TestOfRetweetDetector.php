...
/**
 *
 * ThinkUp/webapp/plugins/statusnet/tests/TestOfRetweetDetector.php
 *
...
class TestOfRetweetDetector extends ThinkUpBasicUnitTestCase {
    ...
    public function testDetectRetweets() {
        ...
        'network'=>'statusnet', 'geo'=>'', 'place'=>'', 'location'=>'', 'is_geo_encoded'=>0, 
        ...
        'network'=>'statusnet', 'geo'=>'', 'place'=>'', 'location'=>'', 'is_geo_encoded'=>0, 'is_reply_by_friend'=>0, 

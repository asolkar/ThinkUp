...
/**
 *
 * ThinkUp/webapp/plugins/statusnet/tests/TestOfStatusNetPluginConfigurationController.php
 *
 ...
 *
 *
 * Test of StatusNetPluginConfigurationController
 *
...
require_once THINKUP_ROOT_PATH.'webapp/plugins/statusnet/controller/class.StatusNetPluginConfigurationController.php';

class TestOfStatusNetPluginConfigurationController extends ThinkUpUnitTestCase {
    ...
    public function testConstructor() {
        $controller = new StatusNetPluginConfigurationController(null, 'statusnet');
     ...
     */
    public function testAddStatusNetUserNoStatusNetAuth() {
        ...
        $owner = $owner_dao->getByEmail(Session::getLoggedInUser());
        $controller = new StatusNetPluginConfigurationController($owner, 'statusnet');
        $_GET["statusnet_username"] = "anildash";
        $_GET["p"]="statusnet";
        $output = $controller->go();
        $v_mgr = $controller->getViewManager();
    ...
    private function buildPluginOptions() {
        ...
        $plugin_options3 =
        FixtureBuilder::build('options',
        array('namespace' => $namespace, 'option_name' => 'num_statusnet_errors', 'option_value' => "5") );

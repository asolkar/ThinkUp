...
/**
 *
 * ThinkUp/webapp/plugins/statusnet/tests/TestOfCrawlerStatusNetAPIAccessorOAuth.php
 *
...
class TestOfCrawlerStatusNetAPIAccessorOAuth extends ThinkUpBasicUnitTestCase {
    var $logger;
    ...
    public function testAPILimit() {
        ...
        $archive_limit = 100;
        $num_statusnet_errors = 100;
        $max_api_calls_per_crawl = 100;
        $api = new CrawlerStatusNetAPIAccessorOAuth('an_oauth_access_token','an_oauth_access_token_secret',

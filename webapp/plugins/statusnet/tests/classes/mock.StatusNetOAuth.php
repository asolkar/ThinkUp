...
/**
 *
 * ThinkUp/webapp/plugins/statusnet/tests/classes/mock.StatusNetOAuth.php
 *
 ...
 */
/**
 * Mock StatusNet OAuth class for tests
 * @license http://www.gnu.org/licenses/gpl.html
 * @copyright 2009-2012 Gina Trapani
 * @author Gina Trapani <ginatrapani[at]gmail[dot]com>
 */
class StatusNetOAuth {

    var $data_path = 'webapp/plugins/statusnet/tests/testdata/';
    ...
    public function oAuthRequest($url, $method = NULL, $args = array()) {
        ...
        $url = str_replace('https://statusnet.com/', '', $url);
        $url = str_replace('https://api.statusnet.com/1/', '', $url);
        $url = str_replace('http://search.statusnet.com/', '', $url);
    ...
    public function http($url) {
        $FAUX_DATA_PATH = THINKUP_ROOT_PATH . 'webapp/plugins/statusnet/tests/testdata/';
        $url = str_replace('https://statusnet.com/', '', $url);
        $url = str_replace('https://api.statusnet.com/1/', '', $url);
        $url = str_replace('http://search.statusnet.com/', '', $url);
        $url = str_replace('/', '_', $url);

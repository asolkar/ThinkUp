...
<div class="section">
    ...
    {foreach from=$leastlikelythisweek key=tid item=u name=foo}
      <div class="avatar-container" style="float:left;margin:7px;">
        <a href="https://statusnet.com/intent/user?user_id={$u.user_id}"  title="{$u.user_name} has {$u.follower_count|number_format} followers and {$u.friend_count|number_format} friends"><img src="{$u.avatar}" class="avatar2"/><img src="{$site_root_path}plugins/{$u.network}/assets/img/favicon.png" class="service-icon2"/></a>
      </div>
    {/foreach}
        <br /><br /><br />
    </div>
    <div class="view-all"><a href="?v=followers-leastlikely&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
...
<div class="view-all"><a href="?v=followers-mostfollowed&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}

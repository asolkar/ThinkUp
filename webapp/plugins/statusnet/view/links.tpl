...
<div class="section">
    ...
    {/foreach}
    <div class="view-all"><a href="?v=links-favorites&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
...
<div class="section">
    ...
    {foreach from=$linksbyfriends key=tid item=l name=foo}
        {include file="_link.tpl" t=$f}
    {/foreach}
    <div class="view-all"><a href="?v=links-friends&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
...
<div class="section">
    ...
    {foreach from=$photosbyfriends key=tid item=l name=foo}
        {include file="_link.tpl" t=$f}
    {/foreach}
    <div class="view-all"><a href="?v=links-photos&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}

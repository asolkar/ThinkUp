...
<div class="section">
    ...
    {/foreach}
    <div class="view-all"><a href="?v=tweets-all&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{else}
...
<div class="section">
    ...
    {/foreach}
    <div class="view-all"><a href="?v=tweets-messages&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
...
<div class="section">
    ...
    {foreach from=$most_replied_to_tweets key=tid item=t name=foo}
        {include file="_post.counts_no_author.tpl" post=$t}
    {/foreach}
    <div class="view-all"><a href="?v=tweets-mostreplies&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
...
<div class="section">
    ...
    {foreach from=$most_retweeted key=tid item=t name=foo}
        {include file="_post.counts_no_author.tpl" post=$t}
    {/foreach}
    <div class="view-all"><a href="?v=tweets-mostretweeted&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
...
<div class="section">
    ...
    {foreach from=$favorites key=tid item=t name=foo}
        {include file="_post.author_no_counts.tpl" post=$t}
    {/foreach}
    <div class="view-all"><a href="?v=ftweets-all&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
...
<div class="section">
    ...
    {foreach from=$inquiries key=tid item=t name=foo}
        {include file="_post.counts_no_author.tpl" post=$t}
    {/foreach}
    <div class="view-all"><a href="?v=tweets-questions&u={$instance->network_username}&n=statusnet">More...</a></div>
</div>
{/if}
